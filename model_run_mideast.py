...
gap2 = pd.read_csv(r'C:\Users\kar.34\GA\ga_application\mideast_sol_check.csv')
#gap2 = gap2.sample(n=100)
nearest_dat = pd.read_pickle(r'C:\Users\kar.34\GA\ga_application\mideast_nearest_rd_no_geom.pkl')
...
param_comb_frac = [param_comb[0:8],
                   param_comb[8:16],
                   param_comb[16:28]]
output_file_name = ["mideast_sol_0_8", 
                    "mideast_sol_8_16", 
                    "mideast_sol_16_28"]
######################### define task #####################################
