...
#gap2 = pd.read_csv(r'E:\PhD work\Inclusive_accessibility_project_work\group_based\sidewalk_gap_linden.csv')
gap2 = pd.read_csv(r'C:\Users\kar.34\GA\ga_application\clintonville_sol_check.csv')
#gap2 = gap2.sample(n=100)
nearest_dat = pd.read_pickle(r'C:\Users\kar.34\GA\ga_application\clintonville_nearest_rd_no_geom.pkl')
...
param_comb_frac = [param_comb[0:8],
                   param_comb[8:16],
                   param_comb[16:28]]
output_file_name = ["clintonville_sol_0_8", 
                    "clintonville_sol_8_16", 
                    "clintonville_sol_16_28"]
######################### define task #####################################
